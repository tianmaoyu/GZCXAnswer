...
namespace GZPIAnswer
{
    class Answer2
    {
        ...
        private static string[] judgeChoice =
        {
            ...
            "校园网贷容易出现网贷平台未履行详尽告知义务违规发放贷款欺诈客户等情形但是只要发生纠纷客户很容易拿到证据:×",
            "各经办机构和经办银行要简化贷款手续不得要求学生提供与贷款申请无关的材料:√",
            "借款学生在校期间若因患病等原因休学应向经办机构提供书面证明然后经办机构向经办行提出申请通过审批后休学期间的贷款利息也由财政全额贴息:√",
            "各经办机构和经办银行要简化贷款手续不得要求学生提供与贷款申请无关的材料:√",
            "学生开具家庭经济困难学生认定证明时收取一定的费用是正常的:×",
            "校园网贷主要通过个体借贷和网诺小额贷款为主个体网络借贷是指个体和个体之间通过互联网平台实现的直接借贷网络小额贷款是指互联网企业通过其控制的小额贷款公司利用互联网向客户提供的小额贷款:√",
        ...
        public static string[] SingleAnserStrings =
        {
            ...
            "71.专本科研究生贷款金额每生每年分别不高于元:B 8000元12000元",
            "72.生源地贷款最长和最短的年限分别是:C 20年6年",
            "73.因病丧失劳动能力家庭遭遇重大自然灾害家庭成员患有重大疾病以及经济收入特别低的借款学生若确实无法偿还贷款可向经办机构经核实后可启动救助机制为其代偿本息:D 提出救助申请并提供相关书面证明",
            "74.按照原政策规定借款学生毕业后需自己承担利息并开始还款但有两年的宽限期在这期间内借款学生只需偿还利息无需偿还本金而现在这一宽限期由原来的调整为年:A 2年3年",
            "75.各级金融监管部门对国家助学贷款业务监管时综合考虑风险补偿金的缓释作用对符合相关政策要求的风险补偿金覆盖部分适用零风险权重未覆盖部分采用的风险权重:C 75%",
            "76.2014年7月1日起本专科学生每人每年生源地信用助学贷款金额最高和最低表述准确的是:D 80001000"
        };
        private static string[] mulitpleChoice =
        {
            ...
            "51.申请助学贷款的支付宝支付密码因注册电子邮箱丢失手机号码无法找回到了贷款还款日期应怎么还款:ACD",

            "52.校园网贷问题科通过哪些途径引诱大学生上当受骗:ABCD",
            "53.2010年李四被贵州某高校本科专业录取学制四年2014年毕业李四于2010年8月5日申请开发银行助学贷款6000元期限10年以下说法错误的有:ACD",
            "54.面对校园网贷层出不穷诱骗危机大学生应该怎么做:BCD",
            "55.从何处可以获知自己生源地信用助学贷款的还款账户号:BD",
            "56.利率担保无服务费借助诱人的公告和网络代理的模式网贷正在大学生群体中飞速蔓延而大学生陷入网贷诈骗的事件也是层出不穷我们可以从哪些方面保护我们自身安全:ABCD",
            "57.国家助学贷款学生不包括哪些学生:BCD",
            "58.个人信用信息基础数据库已经覆盖全国银行类金融机构各级信贷营业网点包括以及住房公积金管理中心小额信贷公司和汽车金融公司等:ABCD",
            "59.申请生源地贷款的学生须符合以下哪些条件:ABCD",
        ...
        public static string[] mulitpleAnserStrings =
       {
            ...
            "53.校园网贷问题科通过哪些途径引诱大学生上当受骗:ABCD",
            "54.2010年李四被贵州某高校本科专业录取学制四年2014年毕业李四于2010年8月5日申请开发银行助学贷款6000元期限10年以下说法错误的有:A.假如2014年李四考入其他高校金融学专业三年制研究生可前往县学生资助管理中心办理合同计划变更还款期可延长至2020年,C.李四可于2013年提前还款还款时需自付利息,D.李四的贷款于2017年8月31日到期到期日需还本6000元",
            "55.面对校园网贷层出不穷诱骗危机大学生应该怎么做:B.自觉了解金融信贷和网络安全知识及相关法律法规知识,C.加强防范意识识别出网贷中的陷阱,D.加强自我管理能力培养勤俭意识",
            "56.从何处可以获知自己生源地信用助学贷款的还款账户号:B.国家开发银行助学贷款学生在线系统,D.查看申请贷款时签订的合同",
            "57.利率担保无服务费借助诱人的公告和网络代理的模式网贷正在大学生群体中飞速蔓延而大学生陷入网贷诈骗的事件也是层出不穷我们可以从哪些方面保护我们自身安全:ABCD",
            "58.国家助学贷款学生不包括哪些学生:B.预科生,C.委培硕士单考硕士MPAMBA等在职研究生,D.自考生",
            "59.个人信用信息基础数据库已经覆盖全国银行类金融机构各级信贷营业网点包括以及住房公积金管理中心小额信贷公司和汽车金融公司等:ABCD",
            "60.申请生源地贷款的学生须符合以下哪些条件:ABCD",

            "61.校园网贷的主要特征:A.利率收益较高,C.平台种类繁多,D.网贷门槛低",
        };
